...
public class PaymentPageLocators {
	...
	public static By makePaymentButton=By.xpath("//*[@resource-id='validateUser']");//By.xpath("//*[@resource-id='vpAddress']//parent::android.view.View//following::android.view.View[1]/android.widget.Button[@text='Make Payment']");
